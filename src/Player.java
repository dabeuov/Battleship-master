...
public class Player implements PlayerInterface {
	 ...
	 */
	private ShipEnum[][] shipPlacement = 
		new ShipEnum[PlayerInterface.NUMBERS.length][PlayerInterface.LETTERS.length];

	/**
	 * Double array used to store whether the chosen button was a hit or a miss.
	 */
	private boolean[][] hitOrMiss = 
		new boolean[PlayerInterface.NUMBERS.length][PlayerInterface.LETTERS.length];
	...
	public final void setShipInputBoard() {
		...
		grid = new JButton[PlayerInterface.LETTERS.length]
		                   [PlayerInterface.NUMBERS.length];
